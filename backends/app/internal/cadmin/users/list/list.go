...
// 	"github.com/izetmolla/uetapp/models"
// 	"github.com/izetmolla/uetapp/pkg/datatable"
// 	"github.com/izetmolla/uetapp/pkg/datatable/postgresql"
// )

// func (cc *controller) GetUsersList(c fiber.Ctx) error {
// 	db, err := cc.drivers.DB()
// 	if err != nil {
...
// 	return c.JSON(datatable.GetColumns(columns))
// }
