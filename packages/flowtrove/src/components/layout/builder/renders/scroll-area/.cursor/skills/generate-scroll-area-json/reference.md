# Scroll Area — JSON reference

TypeScript: `renders/scroll-area/types.ts`.

Registered manifest types: `scroll-area`.
...
## ScrollAreaItem (`type: "scroll-area"`)

Extends `BaseLayoutItem`.

| Field | Type | Description |
|-------|------|-------------|
| `type` | `"scroll-area"` | Discriminant |
| `id` | string | Unique identifier |
| `children` | — |  |
