# Pagination — JSON reference

TypeScript: `renders/pagination/types.ts`.

Registered manifest types: `pagination`.
...
## PaginationItem (`type: "pagination"`)

Extends `BaseLayoutItem`.

| Field | Type | Description |
|-------|------|-------------|
| `type` | `"pagination"` | Discriminant |
| `id` | string | Unique identifier |
| `children` | — |  |
