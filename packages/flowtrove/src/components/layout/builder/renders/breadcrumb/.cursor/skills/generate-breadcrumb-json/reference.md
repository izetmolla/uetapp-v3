# Breadcrumb — JSON reference

TypeScript: `renders/breadcrumb/types.ts`.

Registered manifest types: `breadcrumb`.
...
## BreadcrumbItem (`type: "breadcrumb"`)

Extends `BaseLayoutItem`.

| Field | Type | Description |
|-------|------|-------------|
| `type` | `"breadcrumb"` | Discriminant |
| `id` | string | Unique identifier |
| `children` | — |  |
