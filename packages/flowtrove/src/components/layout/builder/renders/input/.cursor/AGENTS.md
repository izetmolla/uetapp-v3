# Flowtrove Layout Builder — Input render

Maps layout JSON (`input`) to UI components via **LayoutBuilder**.

## Documentation map

| Doc | Use when |
|-----|----------|
| [skills/generate-input-json/SKILL.md](skills/generate-input-json/SKILL.md) | **Start here** — generate or validate JSON |
| [skills/generate-input-json/reference.md](skills/generate-input-json/reference.md) | Full prop schema |
| [skills/generate-input-json/examples.md](skills/generate-input-json/examples.md) | Copy-paste JSON patterns |
...
- [rules/input-render-core.mdc](rules/input-render-core.mdc)

## MCP / AI output contract

1. Always set `type` + unique `id` on every item.
2. Valid types for this folder: `input`.
