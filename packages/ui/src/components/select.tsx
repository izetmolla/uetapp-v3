...
function SelectTrigger({
  ...
  return (
    <div className={notFullWidth ? "relative" : "w-full relative"}>
      {cloarable && <div className="absolute right-9 top-1.5  flex items-center">
        <XIcon
          className="h-4 mx-0.5 cursor-pointer text-muted-foreground"
          onClick={(event) => {
            if (handleClear) {
