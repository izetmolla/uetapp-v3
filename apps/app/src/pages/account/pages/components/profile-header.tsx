        ...
        <div className="relative">
            <div className="relative aspect-[3/1] max-h-40 w-full overflow-hidden sm:aspect-[4/1] md:max-h-44">
                <div
                    ...
                    style={{
                        backgroundImage: "url('https://img.magnific.com/free-photo/gradient-dark-blue-futuristic-digital-background_53876-160646.jpg?semt=ais_hybrid&w=740&q=80')",
                    }}
                />
            ...
            <div className="relative bg-card px-4 pb-3 pt-1 sm:px-5 sm:pb-4">
                <div className="flex flex-col items-center gap-1.5 text-center sm:items-start sm:text-left">
                    <div className="relative -mt-12 sm:-mt-14">
                        <Avatar className="border-background size-20 border-[3px] shadow-md sm:size-24">
                            ...
                            <AvatarFallback className="text-base font-medium">
                                {generateAvatarFallback(`${user?.first_name} ${user?.last_name}`)}
                            </AvatarFallback>
                        </Avatar>
                        <Button
                            type="button"
                    ...
                    <h2 className="text-lg font-semibold tracking-tight sm:text-xl">{`${user?.first_name} ${user?.last_name}`}</h2>
