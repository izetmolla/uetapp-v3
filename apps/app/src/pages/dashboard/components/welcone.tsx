                ...
                <div className="grid items-center pt-6 lg:grid-cols-3">
                    ...
                    <figure className="hidden lg:col-span-1 lg:block">
                        <img
                            width={100}
                            height={50}
                            src={`https://uet.izetmolla.com/static/app/0.0.59/images/academy-dashboard-light.svg`}
                        ...
                        <img
                            width={100}
                            height={50}
                            src={`https://uet.izetmolla.com/static/app/0.0.59/images/academy-dashboard-dark.svg`}
                    ...
                    <img
                        width={800}
                        height={300}
                        src={`https://uet.izetmolla.com/static/app/0.0.59/images/star-shape.png`}
