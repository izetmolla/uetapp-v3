...
export function getActionsColumn(
    setRowAction?: React.Dispatch<React.SetStateAction<DataTableRowAction<StudyLevel> | null>>,
): ColumnDef<StudyLevel>[] {
    return [
        {
            id: "actions",
            cell: ({ row }) => (
...
export function prependColumns(): Array<{ id: string } & Partial<ColumnDef<StudyLevel>>> {
    return [
        withNameColumnLayout<StudyLevel>({
            id: "name",
            cell: ({ row }) => (
                <EntityNameCell
