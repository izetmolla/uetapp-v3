                        ...
                        <div className="w-full max-w-[450px] bg-white rounded-[12px] p-8 shadow-2xl">
                            <div className="space-y-3">
                                ...
                                <div className="text-left space-y-2">
                                    ...
                                    <p className="text-base font-normal text-gray-600">{t("Continue to Flowtrove")}</p>
                                </div>
                                ...
                                <div className="text-left">
                                    <Link to="/register" className="text-sm text-blue-600 hover:text-blue-700 hover:underline cursor-pointer">{t("New to Flowtrove? Get started")} →</Link>
                                </div>
